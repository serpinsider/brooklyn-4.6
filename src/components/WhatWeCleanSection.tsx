      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto overflow-x-auto bg-[rgba(15,23,42,0.95)] backdrop-blur-md rounded-lg shadow-xl mb-20">
          <table className="w-full border-collapse">
            <thead>
              <tr>
                <th className="p-2 sm:p-3 bg-[rgba(15,23,42,0.98)] border border-white/10 text-white w-2/5 text-left text-xs sm:text-sm">Cleaning Tasks</th>
                <th className="p-2 sm:p-3 bg-[rgba(15,23,42,0.98)] border border-white/10 text-white text-center text-xs sm:text-sm">Standard</th>
                <th className="p-2 sm:p-3 bg-[rgba(15,23,42,0.98)] border border-white/10 text-white text-center text-xs sm:text-sm">Deep</th>
                <th className="p-2 sm:p-3 bg-[rgba(15,23,42,0.98)] border border-white/10 text-white text-center text-xs sm:text-sm">Move-In</th>
              </tr>
            </thead>
            <tbody>
        ...
        <div className="max-w-5xl mx-auto mb-24">
          ...
          <p className="text-center text-white/70 text-sm mb-6">
            <strong className="text-[#dfbd69]">Deep Clean:</strong> Extra time for baseboards, windowsills, doorframes, tile & grout<br />
            <strong className="text-[#dfbd69]">Move Out:</strong> Everything in a deep clean plus inside all cabinets
          </p>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {ADDONS
              .filter(({ key }) => !['baseboardCleaning', 'wallStainRemoval', 'tileAndGrout', 'dishes', 'superDeepClean'].includes(key))
