...
export default function HandymanQuoteForm() {
  ...
  const handleSubmit = async () => {
    ...
    const confirmNum = 'BK-HANDY-' + Math.random().toString(36).substring(2, 8).toUpperCase();
    ...
    try {
      const response = await fetch('https://formspree.io/f/mqazolgp', {
        ...
        body: JSON.stringify({
          ...
          _subject: `Brooklyn Maids - Handyman Quote from ${formData.firstName} ${formData.lastName} - #${confirmNum}`,
