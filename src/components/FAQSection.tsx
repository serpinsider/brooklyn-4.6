...
export default function FAQSection({ location = "Brooklyn" }: FAQSectionProps) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "We ask for at least 24 hours notice for cancellations or rescheduling. Late cancellations may incur a small fee.\n\nThat said, we're always flexible — if something comes up, just reach out and we'll work with you."
    },
    {
      question: "How is pricing determined?",
      answer: "Our quotes are based on your home's size, number of bedrooms and bathrooms, and the type of cleaning (standard, deep, or move-out).\n\nYou can get an instant, accurate quote in 60 seconds using our quote form — no hidden fees and no contracts required.\n\n<div class='flex flex-col sm:flex-row gap-3 mt-4'><a href='/quote' class='bg-[#dfbd69] text-slate-900 px-6 py-3 rounded-lg font-semibold text-center hover:bg-[#dfbd69]/90 transition-colors'>Get Your Free Quote</a></div>"
    },
    {
      question: "What if I'm not satisfied with the cleaning?",
      answer: "We offer a 100% satisfaction guarantee. If anything wasn't cleaned to your standard, contact us within 24 hours and we'll come back to make it right — at no extra charge.\n\nYour satisfaction is our priority and we don't consider a job done until you're happy."
    }
  ];
