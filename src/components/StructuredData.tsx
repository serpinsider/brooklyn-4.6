...
interface StructuredDataProps {
  type: 'local-business' | 'service' | 'location' | 'organization' | 'website' | 'faq' | 'breadcrumb';
  data?: {
    location?: string;
    service?: string;
    cities?: string[];
    ...
    switch (type) {
      ...
      case 'website':
        return {
          ...
          "url": "https://brooklynmaids.com",
          "description": "Professional house cleaning and maid service serving Brooklyn, Manhattan, Queens, and NYC. Deep cleaning, move-out cleaning, and more."
        };
        ...
        return {
          ...
          "hasOfferCatalog": {
            ...
            "itemListElement": [
              ...
              {
                "@type": "Offer",
                "itemOffered": { "@type": "Service", "name": "Deep Cleaning", "description": "Thorough cleaning of hard-to-reach areas, baseboards, and more" }
              },
              {
                "@type": "Offer",
                "itemOffered": { "@type": "Service", "name": "Move-Out Cleaning", "description": "Complete cleaning to get your deposit back" }
              },
              {
                "@type": "Offer",
                "itemOffered": { "@type": "Service", "name": "Apartment Cleaning", "description": "Cleaning for apartments of all sizes" }
              }
            ]
          }
        };
        ...
        return {
          ...
          "hasOfferCatalog": {
            ...
            "itemListElement": [
              {
                "@type": "Offer",
                "itemOffered": { "@type": "Service", "name": "Standard Cleaning", "description": "Regular maintenance cleaning" }
              },
              {
                "@type": "Offer",
                "itemOffered": { "@type": "Service", "name": "Deep Cleaning", "description": "Thorough, detailed cleaning service" }
              },
              {
                "@type": "Offer",
