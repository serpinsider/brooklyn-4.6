        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden lg:flex items-center h-20 relative">
            ...
            <div className="flex items-center space-x-4">
              <a href={CONTACT_INFO.phone.href} className="text-[#dfbd69] hover:text-[#dfbd69]/80 transition-all duration-300 hover:-translate-y-[1px] group">
              ...
              <a href={`sms:${CONTACT_INFO.phone.raw}`} className="text-[#dfbd69] hover:text-[#dfbd69]/80 transition-all duration-300 hover:-translate-y-[1px] group">
                <svg className="w-6 h-6 transition-transform duration-300 group-hover:rotate-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
