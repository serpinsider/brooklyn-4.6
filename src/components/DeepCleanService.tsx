...
export default function DeepCleanService() {
  ...
  const whenToBook = [
    {
      title: "Haven't Cleaned Recently",
      description: "If it's been over a month since your last cleaning, a deep clean gets you back on track."
    },
    {
      title: "Dusty or Dirty Homes",
      description: "Homes with visible dust buildup, pet hair, or general grime need extra attention."
    },
    {
  ...
  return (
    <>
      ...
      <DeepCleanHero location="Brooklyn, NY" />
      <QuoteBar />
      ...
      <section className="py-20" style={INLINE_STYLES.secondary}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            <a href="/quote" className="bg-transparent hover:bg-white/10 border border-[#dfbd69] text-[#dfbd69] px-5 py-2.5 rounded-lg transition-all duration-300 inline-block">
