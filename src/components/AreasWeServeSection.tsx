  ...
  return (
    <section id="areas" className="pt-20 pb-12" style={INLINE_STYLES.primary}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-5 lg:gap-8 mb-8">
          {/* NYC Boroughs with Links */}
          <div className="bg-[rgba(15,23,42,0.95)] backdrop-blur-md rounded-xl shadow-xl border border-white/10 p-6 md:p-5 lg:p-8">
        ...
        <div className="text-center">
          <p className="text-white/80 text-base">
            We also serve <Link href="/locations/new-jersey" className="text-[#dfbd69] hover:underline font-semibold">Northern New Jersey</Link> including Jersey City, Hoboken, and surrounding areas.
          </p>
        </div>
