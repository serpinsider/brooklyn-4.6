...
export default function PostConstructionQuoteForm() {
  ...
  const handleSubmit = async () => {
    ...
    const confirmNum = 'BK-POST-' + Math.random().toString(36).substring(2, 8).toUpperCase();
    ...
    try {
      const response = await fetch('https://formspree.io/f/mqazolgp', {
        ...
        body: JSON.stringify({
          ...
          _subject: `Brooklyn Maids - Post-Construction Quote from ${formData.firstName} ${formData.lastName} - #${confirmNum}`,
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
        <div className="lg:col-span-2 backdrop-blur-md p-8 rounded-xl shadow-xl border border-white/10" style={{ background: getFormBg() }}>
          ...
          <div className="space-y-6">
            ...
            <p className="text-xs text-white/60 text-center mb-4 mt-8">By submitting this form, you agree to receive communications from Brooklyn Maids regarding your quote request.</p>
