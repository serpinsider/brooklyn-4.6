        ...
        <div className="py-12 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-8 gap-y-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li><Link href="/locations/new-jersey" className="text-xs text-white/80 hover:text-white">Northern NJ</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li><Link href="/partners" className="text-xs text-white/80 hover:text-white">Partner With Us</Link></li>
            </ul>
          </div>
