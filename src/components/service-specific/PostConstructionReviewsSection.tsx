...
const postConstructionReviews = [
  {
    ...
    rating: 5,
    text: "Just finished a full home renovation. Brooklyn Maids removed all the dust and debris. House was move-in ready in one day!",
    date: "1 week ago",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-sm sm:text-base text-white/70 max-w-3xl mx-auto">
            Trusted by Brooklyn homeowners and contractors for construction cleanup.
          </p>
        </div>
