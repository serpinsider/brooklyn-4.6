...
const airbnbReviews = [
  ...
  },
  {
    ...
    rating: 5,
    text: "They handle everything - cleaning, linens, and restocking. My 5-star ratings went up after I started using Brooklyn Maids!",
    date: "5 days ago",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-sm sm:text-base text-white/70 max-w-3xl mx-auto">
            Trusted by Brooklyn Airbnb and VRBO hosts for reliable turnover cleaning.
          </p>
        </div>
