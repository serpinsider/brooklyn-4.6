...
const commercialReviews = [
  ...
  },
  {
    ...
    rating: 5,
    text: "We run a dental practice and cleanliness is critical. Brooklyn Maids understands medical-grade cleaning. Highly professional team!",
    date: "2 weeks ago",
  ...
  },
  {
    id: 5,
    name: "Brian T.",
    location: "Downtown Brooklyn Gym",
    rating: 5,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-sm sm:text-base text-white/70 max-w-3xl mx-auto">
            Trusted by Brooklyn businesses for reliable commercial cleaning.
          </p>
        </div>
