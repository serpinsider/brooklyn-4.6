...
export const TYPOGRAPHY = {
  ...
  description: "text-base lg:text-lg text-gray-100 leading-relaxed drop-shadow-md",
  ...
  // Hero description
  heroDescription: "text-base lg:text-lg text-gray-100 mb-8 leading-relaxed drop-shadow-md",
