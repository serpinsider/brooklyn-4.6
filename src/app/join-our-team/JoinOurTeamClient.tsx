...
export default function JoinOurTeamClient() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const applicationNumber = 'BK-APP-' + Math.random().toString(36).substring(2, 8).toUpperCase();
      ...
      const structuredData = {
        ...
        applicationNumber,
        _subject: `Maid Application from ${formData.firstName} ${formData.lastName} - #${applicationNumber}`,
  ...
  return (
    <div className="min-h-screen pt-48 pb-12" style={{ background: 'rgba(15, 23, 42, 1)' }}>
        ...
        <div className="bg-slate-800/50 backdrop-blur-md p-8 rounded-xl shadow-xl border border-white/10">
          ...
          <div className="space-y-6">
            ...
            <p className="text-xs text-white/60 text-center mt-4 leading-relaxed">
              By submitting this form, you agree to receive communications from Brooklyn Maids regarding your application.
              <br />
