...
export default function EventCleaningQuoteClient() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const confirmationNumber = 'BK-EVENT-' + Math.random().toString(36).substring(2, 8).toUpperCase();
      ...
      const structuredData = {
        ...
        _subject: `Brooklyn Maids - Event Cleaning Quote from ${formData.firstName} ${formData.lastName} - #${confirmationNumber}`,
