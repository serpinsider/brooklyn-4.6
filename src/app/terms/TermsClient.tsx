...
export default function TermsClient() {
  return (
    <main className="pt-48 pb-16 px-4" style={{ background: 'rgba(15, 23, 42, 1)' }}>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-white/80">
              <p>Brooklyn Maids is fully insured and bonded. However:</p>
              <ul className="list-disc pl-6 space-y-2">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-white/80">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>Brooklyn (all neighborhoods)</li>
                <li>Manhattan</li>
                <li>Queens</li>
                <li>Bronx</li>
                <li>Staten Island</li>
